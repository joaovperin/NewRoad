 ...
 * @author 0199831
 */
public class GameOver extends BasicGameState implements InputProviderListener {
    ...
    public void init(GameContainer gc, StateBasedGame game) throws SlickException {
        ...
        // Instancia InputProvider da tela de fim de jogo
    ...
    public void render(GameContainer container, StateBasedGame game, Graphics g) throws SlickException {
        ...
        if (draw && clickedL) {
            String str = "No, you'll not play this game. YOU JUST DIED, NOOB!";
            g.setColor(Color.black);
            g.setFont(font);
